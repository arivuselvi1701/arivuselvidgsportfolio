    ...
    <section id="home" className="relative h-screen min-h-[700px] w-full overflow-hidden flex flex-col justify-between pt-32 pb-12 px-8 md:px-16 text-white selection:bg-white selection:text-black">
      ...
      <div className="relative z-10 w-full flex flex-col md:flex-row items-end justify-between gap-8 mb-4">
        ...
        >
          ...
          <div className="flex flex-col text-[11px] md:text-xs font-semibold tracking-[0.15em] leading-relaxed text-white/80 uppercase">
        ...
        <motion.div 
          ...
          className="w-full md:w-[380px] bg-[#1a1515]/80 backdrop-blur-md border border-white/5 p-8 flex flex-col"
        >
