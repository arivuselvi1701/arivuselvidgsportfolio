            ...
            <ul className="space-y-6 border-l border-white/10 pl-6 relative">
              {sections.map((section, idx) => (
                <li key={section.id}>
                  ...
                  >
                    <span className={`absolute -left-[4.5px] w-[9px] h-[9px] rounded-full transition-all duration-300 ${activeSection === section.id ? 'bg-white shadow-[0_0_10px_rgba(255,255,255,0.8)] scale-110' : 'bg-white/20'}`}></span>
